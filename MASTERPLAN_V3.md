# MASTERPLAN v3 — BNPL Trap

**Author:** Siddharth Verma (UIUC, *Quantamental Investment*, Spring 2026)
**Date:** 2026-04-18
**Status:** **LOCKED_V3_FINAL 2026-04-18.** Supersedes `MASTERPLAN_V2.md`
and the interim `v3.1` working revision. v2 remains the reference for
...
9. **Stress-test visualization** — Streamlit dashboard renders the joint
   ...
   P&L, with the default $(1.5, 8)$ node annotated and survival-region
   contours overlaid. This is the "stress-test" tab of the pod dashboard
   and the figure replicated in the paper's §11 results section.
